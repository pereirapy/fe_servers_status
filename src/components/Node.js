...
const Node = ({ node, expanded, toggleNodeExpanded, blocks, getNodeBlocks }) => {
  ...
  return (
    ...
    >
      ...
      {expanded && node.online && <ExpansionPanelDetails>
        <Blocks getNodeBlocks={getNodeBlocks} blocks={blocks} node={node} />
      </ExpansionPanelDetails>}
    </ExpansionPanel>
  );
};
